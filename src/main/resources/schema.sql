-- DROP TABLES en orden correcto (hijas primero)
...
CREATE TABLE USUARIO (
                         ...
                         CONSTRAINT USUARIO_PK PRIMARY KEY (rut_usuario)
);
...
CREATE TABLE ADMINISTRADOR (
                               ...
                               CONSTRAINT ADMINISTRADOR_PK PRIMARY KEY (rut_usuario)
);

CREATE TABLE CLIENTE (
                         rut_usuario NUMBER(8) NOT NULL,
                         estado_cuenta VARCHAR2(20) NOT NULL,
                         CONSTRAINT CLIENTE_PK PRIMARY KEY (rut_usuario)
);

CREATE TABLE EMPLEADO (
                          rut_usuario NUMBER(8) NOT NULL,
                          id_sucursal INTEGER,
                          CONSTRAINT EMPLEADO_PK PRIMARY KEY (rut_usuario)
);
...
CREATE TABLE DESCUENTO (
                           ...
                           tipo_descuento VARCHAR2(10) NOT NULL,
...
CREATE TABLE ENVIO (
                       ...
                       metodo_envio VARCHAR2(20) DEFAULT 'STANDARD' NOT NULL,
                       id_sucursal INTEGER
);
...
ALTER TABLE DEVOLUCION ADD CONSTRAINT estado_devo_check CHECK (estado_devo IN ('SOLICITADA', 'EN PROCESO', 'APROBADA', 'COMPLETADA', 'DENEGADA'));
