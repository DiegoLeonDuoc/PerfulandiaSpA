...
CREATE TABLE PRODUCTOS_CARRITO (
                                   id_productos_carrito INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                                   id_producto          INT                              NOT NULL,
...
CREATE TABLE PRODUCTOS_PEDIDO (
                                  id_productos_pedido INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                                  cant_prod           INT                              NOT NULL,
...
ALTER TABLE DEVOLUCION       ADD CONSTRAINT fk_dev_pp FOREIGN KEY(id_producto_pedido) REFERENCES PRODUCTOS_PEDIDO(id_productos_pedido);
