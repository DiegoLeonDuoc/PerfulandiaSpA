-- 1. Usuarios base (tabla padre)
INSERT INTO USUARIO
(rut_usuario,dv_usuario,nom_usuario,nom2_usuario,apellido_paterno,apellido_materno,sexo_usuario,dir_usuario,fecha_nacimiento,telefono_usuario,tel2_usuario,email_usuario,pass_usuario,tipo_usuario)
VALUES
...
-- 2. Sucursales (debe ir antes que Empleado)
...
-- 3. Roles derivados (dependen de USUARIO y SUCURSAL)
INSERT INTO CLIENTE (rut_usuario, estado_cuenta) VALUES (10000001,'ACTIVO');
INSERT INTO EMPLEADO (rut_usuario, id_sucursal) VALUES (20000002,1); -- Ahora SUCURSAL existe
...
-- 9. Pedido (depende de SUCURSAL y CLIENTE)
...
-- 10. Productos en Carrito (depende de PRODUCTO y CARRITO)
INSERT INTO PRODUCTOS_CARRITO(id_producto,id_carrito,cant_prod) VALUES
                                                                    (1,1,2),
                                                                    (2,1,1);

-- 11. Productos en Pedido (depende de PEDIDO y DESCUENTO)
INSERT INTO PRODUCTOS_PEDIDO(cant_prod,precio_unitario,descuento_unitario,precio_total_prod,id_descuento,id_pedido,id_producto) VALUES
                                                                                                                                    (2,200,100,300,1,1,1),
                                                                                                                                    (1,1200,120,1080,2,1,2);

-- 12. Reabastecimientos (depende de SUCURSAL, PRODUCTO y PROVEEDOR)
INSERT INTO REABASTECIMIENTO(cant_productos,fecha_reabas,estado_reabas,id_sucursal,id_producto,id_proveedor) VALUES
                                                                                                                 (50,'2024-05-10','RECIBIDO',1,1,1),
                                                                                                                 (20,'2024-05-15','EN ESPERA',2,2,2);

-- 13. Envíos (depende de PEDIDO)
